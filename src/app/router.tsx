...
const LandingPage = () =>
  import("../features/auth/LandingPage").then((m) => ({ Component: m.LandingPage }));

const SignInPage = () =>
  import("../features/auth/SignInPage").then((m) => ({ Component: m.SignInPage }));

const SignUpPage = () =>
  import("../features/auth/SignUpPage").then((m) => ({ Component: m.SignUpPage }));
